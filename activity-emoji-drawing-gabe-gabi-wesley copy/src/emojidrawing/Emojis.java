...
public class Emojis {
    ...
    public static GraphicsGroup createSmileyFace(double size) {
        ...
        righteye.setPosition(size * 0.6, size * 0.3);
        group.add(righteye);
        
        Ellipse lefteye = createEye(size * 0.1, size * 0.1); 
        lefteye.setFillColor(EYE_COLOR);
        lefteye.setPosition(size * 0.3, size * 0.3);
        group.add(lefteye);
    ...
    public static GraphicsGroup createWinkingFace(double size) {
        ...
        Ellipse righteye = createEye(size * 0.001, size * 0.1); 
        righteye.setFillColor(EYE_COLOR);
        righteye.setPosition(size * 0.6, size * 0.35);
        group.add(righteye);
    ...
    private static Ellipse createEye(double height, double width) {
        ...
        // Ellipse eye = new Ellipse(size * 0.3, size * 0.3, size * 0.1, size * 0.1);
